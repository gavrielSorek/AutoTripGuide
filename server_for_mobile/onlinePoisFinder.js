...
async function getPoisList(bounds, language) {
    ...
    var pois = []
    for (var i = 0; i < 3; i++) { // TODO CHANGE TO LENGTH WHEN NOT DEBUGING
...
async function getlightPois(bounds, language) {
    ...
    var reqUrl = apiUrl + `?lon_min=${bounds['southWest'].lng}&lat_min=${bounds['southWest'].lat}&lon_max=${bounds['northEast'].lng}&lat_max=${bounds['northEast'].lat}&kinds=churches&format=geojson&apikey=${apiKey}`
...
// function getBounds(){
//     user_data = {lat : 31.778, lng : 35.2354} 
//     var epsilon = 0.07
//     var relevantBounds = {}
