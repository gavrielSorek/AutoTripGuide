...
class Guide {
  ...
  late AutoGuideDialogBox guideDialogBox;
  int loadingAnimationTime = 10; // default
  bool _inIntro = false;

  Guide(this.context, this.guideData) {
    guideDialogBox = AutoGuideDialogBox(
        key: UniqueKey());
      }
  ...
  void handlePois() async {
    guideDialogBox.setPoisToPlayWhenFinished(Globals.globalAllPois);
  }
...
//         opacity: WidgetVisibility.view == dialogVisibility ? 1.0 : 1.0,
