...
import 'package:journ_ai/Map/mapbox/user_location_marker_car.dart';
...
class UserMap extends StatefulWidget {
  ...
  Future<void> mapInit(context) async {
    ...
    BackgroundLocationService.instance.onLocationChanged.listen((locationData) {
       locationChangedEvent(locationData);
    });
  ...
  void setPoisScanningStatus(bool isActive) {
    isScanning = isActive;
    if (isActive) {
      loadNewPois(locationData: userLocation);
